...
DXL_MINIMUM_POSITION_VALUE  = 2600           # Dynamixel will rotate between this value
DXL_MAXIMUM_POSITION_VALUE  = 3900            # and this value (note that the Dynamixel would not move when the position value is out of movable range. Check e-manual about the range of the Dynamixel you use.)
