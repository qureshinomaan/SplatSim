...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    if override_color is None:
        ...
        # if True:
            ...
            dir_pp = (pc.get_xyz - viewpoint_camera.camera_center.repeat(pc.get_features.shape[0], 1)) # shape (N, 3)
            # dir_pp = (pc.xyz_init - viewpoint_camera.camera_center.repeat(pc.get_features.shape[0], 1)) # shape (N, 3)
