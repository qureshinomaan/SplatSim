...
class PybulletRobotServer:
    def __init__(
        ...
        self.object_name_list = [ 'redblock', 'plastic_apple', 'plastic_banana', 'plastic_orange', 'greenblock', 'plate']
        ...
        for object_name in range(len(self.object_name_list)):
            if self.object_name_list[object_name] in models_lib.model_name_list:
                object_loaded = self.pybullet_client.loadURDF(models_lib[self.object_name_list[object_name]], [self.x_list[object_name][0], self.x_list[object_name][1], 0.0], quat,)
                ...
                object_loaded = self.pybullet_client.loadURDF(object_path,  [self.x_list[object_name][0], self.x_list[object_name][1], 0.0], quat, globalScaling=0.8)
                self.urdf_object_list.append(object_loaded)
        ...
        #add gravity
        self.pybullet_client.setGravity(0, 0, .001)
